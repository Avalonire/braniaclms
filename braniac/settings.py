...
from braniac.github_keys import GITHUB_KEY, GITHUB_SECRET
...
SECRET_KEY = 'django-insecure-s090gwx8q++*0gs$5icn87r52#*@_xa)^(f52ywb0^tn3!dgn-'
...
SELENIUM_DRIVER_PATH = BASE_DIR / 'selenium' / 'geckodriver'
